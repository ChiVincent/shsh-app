...
public final class CipherSuite {
    ...
    public static final CipherSuite TLS_KRB5_EXPORT_WITH_DES_CBC_40_MD5 = of("TLS_KRB5_EXPORT_WITH_DES_CBC_40_MD5", 41, 2712, 6, ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
    public static final CipherSuite TLS_KRB5_EXPORT_WITH_DES_CBC_40_SHA = of("TLS_KRB5_EXPORT_WITH_DES_CBC_40_SHA", 38, 2712, 6, ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
    public static final CipherSuite TLS_KRB5_EXPORT_WITH_RC4_40_MD5 = of("TLS_KRB5_EXPORT_WITH_RC4_40_MD5", 43, 2712, 6, ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
    public static final CipherSuite TLS_KRB5_EXPORT_WITH_RC4_40_SHA = of("TLS_KRB5_EXPORT_WITH_RC4_40_SHA", 40, 2712, 6, ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
    public static final CipherSuite TLS_KRB5_WITH_3DES_EDE_CBC_MD5 = of("TLS_KRB5_WITH_3DES_EDE_CBC_MD5", 35, 2712, 6, ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
    public static final CipherSuite TLS_KRB5_WITH_3DES_EDE_CBC_SHA = of("TLS_KRB5_WITH_3DES_EDE_CBC_SHA", 31, 2712, 6, ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
    public static final CipherSuite TLS_KRB5_WITH_DES_CBC_MD5 = of("TLS_KRB5_WITH_DES_CBC_MD5", 34, 2712, 6, ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
    public static final CipherSuite TLS_KRB5_WITH_DES_CBC_SHA = of("TLS_KRB5_WITH_DES_CBC_SHA", 30, 2712, 6, ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
    public static final CipherSuite TLS_KRB5_WITH_RC4_128_MD5 = of("TLS_KRB5_WITH_RC4_128_MD5", 36, 2712, 6, ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
    public static final CipherSuite TLS_KRB5_WITH_RC4_128_SHA = of("TLS_KRB5_WITH_RC4_128_SHA", 32, 2712, 6, ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
