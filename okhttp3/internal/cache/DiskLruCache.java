...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    private static final Sink NULL_SINK = new C08704();
    private static final String READ = "READ";
    private static final String REMOVE = "REMOVE";
    static final String VERSION_1 = "1";
    private final int appVersion;
    private final Runnable cleanupRunnable = new C05821();
    ...
    class C05833 implements Iterator<Snapshot> {
    ...
    static class C08704 implements Sink {
        C08704() {
        }
    ...
    private synchronized okhttp3.internal.cache.DiskLruCache.Editor edit(java.lang.String r5, long r6) throws java.io.IOException {
        /*
        r4 = this;
        r0 = 0;
        monitor-enter(r4);
        ...
        r1 = (okhttp3.internal.cache.DiskLruCache.Entry) r1;	 Catch:{ all -> 0x003d }
        r2 = -1;
    ...
    L_0x0062:
        r1 = new okhttp3.internal.cache.DiskLruCache$Entry;	 Catch:{ all -> 0x003d }
        r2 = 0;
        r1.<init>(r5);	 Catch:{ all -> 0x003d }
        r2 = r4.lruEntries;	 Catch:{ all -> 0x003d }
        r2.put(r5, r1);	 Catch:{ all -> 0x003d }
    L_0x006d:
        r0 = new okhttp3.internal.cache.DiskLruCache$Editor;	 Catch:{ all -> 0x003d }
        r2 = 0;
