...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    class C06092 extends AccessibilityDelegateCompat {
        C06092() {
        }
    ...
    class C06103 extends BottomSheetCallback {
        C06103() {
        }
    ...
    public BottomSheetDialog(@NonNull Context context, @StyleRes int theme) {
        ...
        this.mBottomSheetCallback = new C06103();
    ...
    private View wrapInBottomSheet(int layoutResId, View view, LayoutParams params) {
        ...
        coordinator.findViewById(C0000R.id.touch_outside).setOnClickListener(new C00081());
        ViewCompat.setAccessibilityDelegate(bottomSheet, new C06092());
        return coordinator;
    }
