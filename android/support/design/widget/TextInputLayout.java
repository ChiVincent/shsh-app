...
public class TextInputLayout extends LinearLayout {
    ...
    class C06245 implements AnimatorUpdateListener {
        C06245() {
        }
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C06251());
        CharSequence error;

        static class C06251 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C06251() {
            }
    ...
    class C09002 extends ViewPropertyAnimatorListenerAdapter {
        C09002() {
        }
    ...
    private void setError(@Nullable final CharSequence error, boolean animate) {
        ...
        if (this.mErrorShown) {
            ...
            if (animate) {
                ...
                ViewCompat.animate(this.mErrorView).alpha(1.0f).setDuration(200).setInterpolator(AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR).setListener(new C09002()).start();
            } else {
        ...
        if (this.mEditText != null) {
            ...
            if (shouldShowPasswordIcon()) {
                if (this.mPasswordToggleView == null) {
                    ...
                    this.mPasswordToggleView.setOnClickListener(new C00154());
                }
    ...
    void animateToExpansionFraction(float target) {
        if (this.mCollapsingTextHelper.getExpansionFraction() != target) {
            if (this.mAnimator == null) {
                ...
                this.mAnimator.addUpdateListener(new C06245());
            }
