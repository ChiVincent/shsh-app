...
public class ParcelableSparseArray extends SparseArray<Parcelable> implements Parcelable {
    public static final Creator<ParcelableSparseArray> CREATOR = ParcelableCompat.newCreator(new C05961());

    static class C05961 implements ParcelableCompatCreatorCallbacks<ParcelableSparseArray> {
        C05961() {
        }
