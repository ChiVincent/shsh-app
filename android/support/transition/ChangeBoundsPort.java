...
class ChangeBoundsPort extends TransitionPort {
    ...
    class C00203 extends AnimatorListenerAdapter {
        C00203() {
        }
    ...
    class C09021 extends TransitionListenerAdapter {
    ...
    class C09032 extends TransitionListenerAdapter {
        boolean mCanceled = false;
            ...
            if (numChanges > 0) {
                ...
                if (this.mResizeClip) {
                    ...
                    if (view.getParent() instanceof ViewGroup) {
                        ...
                        addListener(new C09032());
                    }
                    anim.addListener(new C00203());
                    return anim;
                }
                pvh = new PropertyValuesHolder[numChanges];
                if (startLeft != endLeft) {
