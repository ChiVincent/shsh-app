...
public class SlidingPaneLayout extends ViewGroup {
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C06691());
        boolean isOpen;

        static class C06691 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C06691() {
            }
