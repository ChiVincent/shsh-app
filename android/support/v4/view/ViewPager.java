...
public class ViewPager extends ViewGroup {
    ...
    class C06584 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C06591());
        Parcelable adapterState;
        ClassLoader loader;
        int position;

        static class C06591 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C06591() {
            }
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C06584());
    }
