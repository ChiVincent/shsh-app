...
class AppCompatDelegateImplV9 extends AppCompatDelegateImplBase implements Callback, LayoutInflaterFactory {
    ...
    class C01605 implements Runnable {
        ...
        class C09081 extends ViewPropertyAnimatorListenerAdapter {
            C09081() {
            }
        ...
        public void run() {
            ...
            if (AppCompatDelegateImplV9.this.shouldAnimateActionModeView()) {
                ...
                AppCompatDelegateImplV9.this.mFadeAnim.setListener(new C09081());
                return;
            }
            ViewCompat.setAlpha(AppCompatDelegateImplV9.this.mActionModeView, 1.0f);
            AppCompatDelegateImplV9.this.mActionModeView.setVisibility(0);
    ...
    protected static final class PanelFeatureState {
        ...
        private static class SavedState implements Parcelable {
            public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C06741());
            int featureId;
            boolean isOpen;
            Bundle menuState;

            static class C06741 implements ParcelableCompatCreatorCallbacks<SavedState> {
                C06741() {
                }
    ...
    class C06712 implements OnApplyWindowInsetsListener {
        C06712() {
        }
    ...
    class C06723 implements OnFitSystemWindowsListener {
        C06723() {
        }
    ...
    class C06734 implements OnAttachListener {
        C06734() {
        }
    ...
    class ActionModeCallbackWrapperV9 implements ActionMode.Callback {
        ...
        class C09101 extends ViewPropertyAnimatorListenerAdapter {
            C09101() {
            }
        ...
        public void onDestroyActionMode(ActionMode mode) {
            ...
            if (AppCompatDelegateImplV9.this.mActionModeView != null) {
                ...
                AppCompatDelegateImplV9.this.mFadeAnim.setListener(new C09101());
            }
    ...
    class C09096 extends ViewPropertyAnimatorListenerAdapter {
        C09096() {
        }
        ...
        if (a.hasValue(C0163R.styleable.AppCompatTheme_windowActionBar)) {
            ...
            if (this.mWindowNoTitle) {
                ...
                if (VERSION.SDK_INT >= 21) {
                    ViewCompat.setOnApplyWindowInsetsListener(subDecor, new C06712());
                } else {
                    ((FitWindowsViewGroup) subDecor).setOnFitSystemWindowsListener(new C06723());
                }
            ...
            contentView.setAttachListener(new C06734());
            return subDecor;
        }
        a.recycle();
            ...
            if (this.mActionModeView != null) {
                ...
                if (callback.onCreateActionMode(mode, mode.getMenu())) {
                    ...
                    if (shouldAnimateActionModeView()) {
                        ...
                        this.mFadeAnim.setListener(new C09096());
                    } else {
