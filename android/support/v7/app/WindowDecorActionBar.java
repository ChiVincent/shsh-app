...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C09111();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C09122();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C06763();

    class C06763 implements ViewPropertyAnimatorUpdateListener {
        C06763() {
        }
    ...
    class C09111 extends ViewPropertyAnimatorListenerAdapter {
        C09111() {
        }
    ...
    class C09122 extends ViewPropertyAnimatorListenerAdapter {
        C09122() {
        }
