...
public class Toolbar extends ViewGroup {
    ...
    class C06991 implements android.support.v7.widget.ActionMenuView.OnMenuItemClickListener {
        C06991() {
        }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C07001());
        int expandedMenuItemId;
        boolean isOverflowOpen;

        static class C07001 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C07001() {
            }
    ...
    public Toolbar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        this.mMenuViewItemClickListener = new C06991();
