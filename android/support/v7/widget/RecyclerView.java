...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    class C06924 implements ProcessCallback {
        C06924() {
        }
    ...
    class C06935 implements Callback {
        C06935() {
        }
    ...
    class C06946 implements Callback {
        C06946() {
        }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C06951());
        Parcelable mLayoutState;

        static class C06951 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C06951() {
            }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mViewInfoProcessCallback = new C06924();
        if (attrs != null) {
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C06935());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C06946());
    }
