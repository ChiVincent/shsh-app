...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C06971());
        boolean isIconified;

        static class C06971 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C06971() {
            }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        private int getSearchViewTextMinWidthDp() {
            ...
            if (widthDp >= SettingsJsonConstants.ANALYTICS_FLUSH_INTERVAL_SECS_DEFAULT || (widthDp >= 640 && heightDp >= 480)) {
                return 192;
            }
            return 160;
        }
