...
public class InstallerPackageNameProvider {
    ...
    private final ValueLoader<String> installerPackageNameLoader = new C08551();

    class C08551 implements ValueLoader<String> {
        C08551() {
        }
    ...
    public String getInstallerPackageName(Context appContext) {
        try {
            ...
            Fabric.getLogger().mo2379e(Fabric.TAG, "Failed to determine installer package name", e);
            return null;
        }
    }
}
