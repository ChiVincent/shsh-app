...
public abstract class AsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory threadFactory = new C05511();
    ...
    private final WorkerRunnable<Params, Result> worker = new C08572();
    ...
    class C08572 extends WorkerRunnable<Params, Result> {
        C08572() {
            super();
        }
