...
import com.afollestad.materialdialogs.C0226R;
...
public class MDRootLayout extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0226R.styleable.MDRootLayout, defStyleAttr, 0);
        this.mReducePaddingNoTitleNoButtons = a.getBoolean(C0226R.styleable.MDRootLayout_md_reduce_padding_no_title_no_buttons, true);
        a.recycle();
        this.mNoTitlePaddingFull = r.getDimensionPixelSize(C0226R.dimen.md_notitle_vertical_padding);
        this.mButtonPaddingFull = r.getDimensionPixelSize(C0226R.dimen.md_button_frame_vertical_padding);
        this.mButtonHorizontalEdgeMargin = r.getDimensionPixelSize(C0226R.dimen.md_button_padding_frame_side);
        this.mButtonBarHeight = r.getDimensionPixelSize(C0226R.dimen.md_button_height);
        this.mDividerPaint = new Paint();
        this.mDividerWidth = r.getDimensionPixelSize(C0226R.dimen.md_divider_height);
        this.mDividerPaint.setColor(DialogUtils.resolveColor(context, C0226R.attr.md_divider_color));
    ...
    public void onFinishInflate() {
        ...
        for (int i = 0; i < getChildCount(); i++) {
            View v = getChildAt(i);
            if (v.getId() == C0226R.id.md_titleFrame) {
                this.mTitleBar = v;
            } else if (v.getId() == C0226R.id.md_buttonDefaultNeutral) {
                this.mButtons[0] = (MDButton) v;
            } else if (v.getId() == C0226R.id.md_buttonDefaultNegative) {
                this.mButtons[1] = (MDButton) v;
            } else if (v.getId() == C0226R.id.md_buttonDefaultPositive) {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.mStackBehavior == StackingBehavior.ALWAYS) {
            ...
            stacked = buttonsWidth > width - (getContext().getResources().getDimensionPixelSize(C0226R.dimen.md_neutral_button_margin) * 2);
        }
        int stackedHeight = 0;
        ...
        if (isVisible(this.mTitleBar)) {
            this.mTitleBar.measure(MeasureSpec.makeMeasureSpec(width, 1073741824), 0);
