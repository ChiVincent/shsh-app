...
public class MaterialDialog extends DialogBase implements OnClickListener, InternalListCallback {
    ...
    class C02221 implements OnGlobalLayoutListener {
        C02221() {
        }
            ...
            if (MaterialDialog.this.listType == ListType.SINGLE || MaterialDialog.this.listType == ListType.MULTI) {
                ...
                MaterialDialog.this.recyclerView.post(new Runnable() {
                    public void run() {
                        ...
                        MaterialDialog.this.mBuilder.layoutManager.scrollToPosition(fSelectedIndex);
                    }
                });
            }
        }
    ...
    class C02243 implements TextWatcher {
        C02243() {
        }
    ...
    public static class Builder {
        ...
        public Builder(@NonNull Context context) {
            ...
            this.widgetColor = DialogUtils.resolveColor(context, C0226R.attr.colorAccent, DialogUtils.getColor(context, C0226R.color.md_material_blue_600));
            ...
            this.linkColor = DialogUtils.getActionTextStateList(context, DialogUtils.resolveColor(context, C0226R.attr.md_link_color, this.widgetColor));
            int fallback = 0;
            if (VERSION.SDK_INT >= 21) {
                fallback = DialogUtils.resolveColor(context, 16843820);
            }
            this.buttonRippleColor = DialogUtils.resolveColor(context, C0226R.attr.md_btn_ripple_color, DialogUtils.resolveColor(context, C0226R.attr.colorControlHighlight, fallback));
            this.progressPercentFormat = NumberFormat.getPercentInstance();
            this.progressNumberFormat = "%1d/%2d";
            this.theme = DialogUtils.isColorDark(DialogUtils.resolveColor(context, 16842806)) ? Theme.LIGHT : Theme.DARK;
            checkSingleton();
            this.titleGravity = DialogUtils.resolveGravityEnum(context, C0226R.attr.md_title_gravity, this.titleGravity);
            this.contentGravity = DialogUtils.resolveGravityEnum(context, C0226R.attr.md_content_gravity, this.contentGravity);
            this.btnStackedGravity = DialogUtils.resolveGravityEnum(context, C0226R.attr.md_btnstacked_gravity, this.btnStackedGravity);
            this.itemsGravity = DialogUtils.resolveGravityEnum(context, C0226R.attr.md_items_gravity, this.itemsGravity);
            this.buttonsGravity = DialogUtils.resolveGravityEnum(context, C0226R.attr.md_buttons_gravity, this.buttonsGravity);
            typeface(DialogUtils.resolveString(context, C0226R.attr.md_medium_font), DialogUtils.resolveString(context, C0226R.attr.md_regular_font));
        ...
        public Builder content(@StringRes int contentRes, Object... formatArgs) {
            content(Html.fromHtml(String.format(this.context.getString(contentRes), formatArgs)));
            return this;
        }
        ...
        public Builder inputRange(@IntRange(from = 0, to = 2147483647L) int minLength, @IntRange(from = -1, to = 2147483647L) int maxLength, @ColorInt int errorColor) {
            ...
            if (errorColor == 0) {
                this.inputRangeErrorColor = DialogUtils.getColor(this.context, C0226R.color.md_edittext_error);
            } else {
    ...
    enum ListType {
        ...
        public static int getLayoutForType(ListType type) {
            switch (type) {
                case REGULAR:
                    return C0226R.layout.md_listitem;
                case SINGLE:
                    return C0226R.layout.md_listitem_singlechoice;
                case MULTI:
                    return C0226R.layout.md_listitem_multichoice;
                default:
    ...
    final void checkIfListInitScroll() {
        if (this.recyclerView != null) {
            this.recyclerView.getViewTreeObserver().addOnGlobalLayoutListener(new C02221());
        }
    }
    ...
    public boolean onItemSelected(MaterialDialog dialog, View view, int position, CharSequence text, boolean longPress) {
        ...
        if (this.listType == null || this.listType == ListType.REGULAR) {
            ...
            CheckBox cb = (CheckBox) view.findViewById(C0226R.id.md_control);
            if (!cb.isEnabled()) {
                return false;
            }
            ...
            RadioButton radio = (RadioButton) view.findViewById(C0226R.id.md_control);
            if (!radio.isEnabled()) {
                return false;
            }
    ...
    protected final Drawable getListSelector() {
        ...
        Drawable d = DialogUtils.resolveDrawable(this.mBuilder.context, C0226R.attr.md_list_selector);
        return d == null ? DialogUtils.resolveDrawable(getContext(), C0226R.attr.md_list_selector) : d;
    }
        ...
        if (!isStacked) {
            switch (which) {
                case NEUTRAL:
                    ...
                    d = DialogUtils.resolveDrawable(this.mBuilder.context, C0226R.attr.md_btn_neutral_selector);
                    if (d != null) {
                        return d;
                    }
                    d = DialogUtils.resolveDrawable(getContext(), C0226R.attr.md_btn_neutral_selector);
                    if (VERSION.SDK_INT < 21) {
                        return d;
                    }
                ...
                case NEGATIVE:
                    ...
                    d = DialogUtils.resolveDrawable(this.mBuilder.context, C0226R.attr.md_btn_negative_selector);
                    if (d != null) {
                        return d;
                    }
                    d = DialogUtils.resolveDrawable(getContext(), C0226R.attr.md_btn_negative_selector);
                    if (VERSION.SDK_INT < 21) {
                        return d;
                    }
                    RippleHelper.applyColor(d, this.mBuilder.buttonRippleColor);
                ...
                default:
                    ...
                    d = DialogUtils.resolveDrawable(this.mBuilder.context, C0226R.attr.md_btn_positive_selector);
                    if (d != null) {
                        return d;
                    }
                    d = DialogUtils.resolveDrawable(getContext(), C0226R.attr.md_btn_positive_selector);
                    if (VERSION.SDK_INT < 21) {
                        return d;
                    }
                    RippleHelper.applyColor(d, this.mBuilder.buttonRippleColor);
            ...
            d = DialogUtils.resolveDrawable(this.mBuilder.context, C0226R.attr.md_btn_stacked_selector);
            if (d == null) {
                return DialogUtils.resolveDrawable(getContext(), C0226R.attr.md_btn_stacked_selector);
            }
            return d;
        }
    }
    ...
    private boolean sendMultichoiceCallback() {
        ...
        for (Integer i : this.selectedIndicesList) {
            if (i.intValue() >= 0 && i.intValue() <= this.mBuilder.items.size() - 1) {
    ...
    protected void setInternalInputCallback() {
        if (this.input != null) {
            this.input.addTextChangedListener(new C02243());
        }
    }
