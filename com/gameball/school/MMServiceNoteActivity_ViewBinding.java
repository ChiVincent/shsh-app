...
public class MMServiceNoteActivity_ViewBinding<T extends MMServiceNoteActivity> implements Unbinder {
    protected T target;

    @UiThread
    public MMServiceNoteActivity_ViewBinding(T target, View source) {
        this.target = target;
