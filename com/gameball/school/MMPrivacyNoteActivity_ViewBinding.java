...
public class MMPrivacyNoteActivity_ViewBinding<T extends MMPrivacyNoteActivity> implements Unbinder {
    protected T target;

    @UiThread
    public MMPrivacyNoteActivity_ViewBinding(T target, View source) {
        this.target = target;
