...
public class MMServiceNoteENActivity_ViewBinding<T extends MMServiceNoteENActivity> implements Unbinder {
    protected T target;

    @UiThread
    public MMServiceNoteENActivity_ViewBinding(T target, View source) {
        this.target = target;
