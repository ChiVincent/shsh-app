...
public class LinePageIndicator extends View implements PageIndicator {
    ...
    public LinePageIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, C0485R.attr.vpiLinePageIndicatorStyle);
    }
    ...
    public LinePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (!isInEditMode()) {
            ...
            int defaultSelectedColor = res.getColor(C0485R.color.default_line_indicator_selected_color);
            int defaultUnselectedColor = res.getColor(C0485R.color.default_line_indicator_unselected_color);
            float defaultLineWidth = res.getDimension(C0485R.dimen.default_line_indicator_line_width);
            float defaultGapWidth = res.getDimension(C0485R.dimen.default_line_indicator_gap_width);
            float defaultStrokeWidth = res.getDimension(C0485R.dimen.default_line_indicator_stroke_width);
            boolean defaultCentered = res.getBoolean(C0485R.bool.default_line_indicator_centered);
            TypedArray a = context.obtainStyledAttributes(attrs, C0485R.styleable.LinePageIndicator, defStyle, 0);
            this.mCentered = a.getBoolean(C0485R.styleable.LinePageIndicator_centered, defaultCentered);
            this.mLineWidth = a.getDimension(C0485R.styleable.LinePageIndicator_lineWidth, defaultLineWidth);
            this.mGapWidth = a.getDimension(C0485R.styleable.LinePageIndicator_gapWidth, defaultGapWidth);
            setStrokeWidth(a.getDimension(C0485R.styleable.LinePageIndicator_strokeWidth, defaultStrokeWidth));
            this.mPaintUnselected.setColor(a.getColor(C0485R.styleable.LinePageIndicator_unselectedColor, defaultUnselectedColor));
            this.mPaintSelected.setColor(a.getColor(C0485R.styleable.LinePageIndicator_selectedColor, defaultSelectedColor));
            Drawable background = a.getDrawable(C0485R.styleable.LinePageIndicator_android_background);
            if (background != null) {
