...
public class CirclePageIndicator extends View implements PageIndicator {
    ...
    static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = new C04811();
        int currentPage;

        static class C04811 implements Creator<SavedState> {
            C04811() {
            }
    ...
    public CirclePageIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, C0485R.attr.vpiCirclePageIndicatorStyle);
    }
    ...
    public CirclePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (!isInEditMode()) {
            ...
            int defaultPageColor = res.getColor(C0485R.color.default_circle_indicator_page_color);
            int defaultFillColor = res.getColor(C0485R.color.default_circle_indicator_fill_color);
            int defaultOrientation = res.getInteger(C0485R.integer.default_circle_indicator_orientation);
            int defaultStrokeColor = res.getColor(C0485R.color.default_circle_indicator_stroke_color);
            float defaultStrokeWidth = res.getDimension(C0485R.dimen.default_circle_indicator_stroke_width);
            float defaultRadius = res.getDimension(C0485R.dimen.default_circle_indicator_radius);
            boolean defaultCentered = res.getBoolean(C0485R.bool.default_circle_indicator_centered);
            boolean defaultSnap = res.getBoolean(C0485R.bool.default_circle_indicator_snap);
            TypedArray a = context.obtainStyledAttributes(attrs, C0485R.styleable.CirclePageIndicator, defStyle, 0);
            this.mCentered = a.getBoolean(C0485R.styleable.CirclePageIndicator_centered, defaultCentered);
            this.mOrientation = a.getInt(C0485R.styleable.CirclePageIndicator_android_orientation, defaultOrientation);
            this.mPaintPageFill.setStyle(Style.FILL);
            this.mPaintPageFill.setColor(a.getColor(C0485R.styleable.CirclePageIndicator_pageColor, defaultPageColor));
            this.mPaintStroke.setStyle(Style.STROKE);
            this.mPaintStroke.setColor(a.getColor(C0485R.styleable.CirclePageIndicator_strokeColor, defaultStrokeColor));
            this.mPaintStroke.setStrokeWidth(a.getDimension(C0485R.styleable.CirclePageIndicator_strokeWidth, defaultStrokeWidth));
            this.mPaintFill.setStyle(Style.FILL);
            this.mPaintFill.setColor(a.getColor(C0485R.styleable.CirclePageIndicator_fillColor, defaultFillColor));
            this.mRadius = a.getDimension(C0485R.styleable.CirclePageIndicator_radius, defaultRadius);
            this.mSnap = a.getBoolean(C0485R.styleable.CirclePageIndicator_snap, defaultSnap);
            Drawable background = a.getDrawable(C0485R.styleable.CirclePageIndicator_android_background);
            if (background != null) {
