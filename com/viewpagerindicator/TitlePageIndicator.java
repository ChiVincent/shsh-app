...
public class TitlePageIndicator extends View implements PageIndicator {
    ...
    static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = new C04891();
        int currentPage;

        static class C04891 implements Creator<SavedState> {
            C04891() {
            }
    ...
    public TitlePageIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, C0485R.attr.vpiTitlePageIndicatorStyle);
    }
    ...
    public TitlePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (!isInEditMode()) {
            ...
            int defaultFooterColor = res.getColor(C0485R.color.default_title_indicator_footer_color);
            float defaultFooterLineHeight = res.getDimension(C0485R.dimen.default_title_indicator_footer_line_height);
            int defaultFooterIndicatorStyle = res.getInteger(C0485R.integer.default_title_indicator_footer_indicator_style);
            float defaultFooterIndicatorHeight = res.getDimension(C0485R.dimen.default_title_indicator_footer_indicator_height);
            float defaultFooterIndicatorUnderlinePadding = res.getDimension(C0485R.dimen.default_title_indicator_footer_indicator_underline_padding);
            float defaultFooterPadding = res.getDimension(C0485R.dimen.default_title_indicator_footer_padding);
            int defaultLinePosition = res.getInteger(C0485R.integer.default_title_indicator_line_position);
            int defaultSelectedColor = res.getColor(C0485R.color.default_title_indicator_selected_color);
            boolean defaultSelectedBold = res.getBoolean(C0485R.bool.default_title_indicator_selected_bold);
            int defaultTextColor = res.getColor(C0485R.color.default_title_indicator_text_color);
            float defaultTextSize = res.getDimension(C0485R.dimen.default_title_indicator_text_size);
            float defaultTitlePadding = res.getDimension(C0485R.dimen.default_title_indicator_title_padding);
            float defaultClipPadding = res.getDimension(C0485R.dimen.default_title_indicator_clip_padding);
            float defaultTopPadding = res.getDimension(C0485R.dimen.default_title_indicator_top_padding);
            TypedArray a = context.obtainStyledAttributes(attrs, C0485R.styleable.TitlePageIndicator, defStyle, 0);
            this.mFooterLineHeight = a.getDimension(C0485R.styleable.TitlePageIndicator_footerLineHeight, defaultFooterLineHeight);
            this.mFooterIndicatorStyle = IndicatorStyle.fromValue(a.getInteger(C0485R.styleable.TitlePageIndicator_footerIndicatorStyle, defaultFooterIndicatorStyle));
            this.mFooterIndicatorHeight = a.getDimension(C0485R.styleable.TitlePageIndicator_footerIndicatorHeight, defaultFooterIndicatorHeight);
            this.mFooterIndicatorUnderlinePadding = a.getDimension(C0485R.styleable.TitlePageIndicator_footerIndicatorUnderlinePadding, defaultFooterIndicatorUnderlinePadding);
            this.mFooterPadding = a.getDimension(C0485R.styleable.TitlePageIndicator_footerPadding, defaultFooterPadding);
            this.mLinePosition = LinePosition.fromValue(a.getInteger(C0485R.styleable.TitlePageIndicator_linePosition, defaultLinePosition));
            this.mTopPadding = a.getDimension(C0485R.styleable.TitlePageIndicator_topPadding, defaultTopPadding);
            this.mTitlePadding = a.getDimension(C0485R.styleable.TitlePageIndicator_titlePadding, defaultTitlePadding);
            this.mClipPadding = a.getDimension(C0485R.styleable.TitlePageIndicator_clipPadding, defaultClipPadding);
            this.mColorSelected = a.getColor(C0485R.styleable.TitlePageIndicator_selectedColor, defaultSelectedColor);
            this.mColorText = a.getColor(C0485R.styleable.TitlePageIndicator_android_textColor, defaultTextColor);
            this.mBoldText = a.getBoolean(C0485R.styleable.TitlePageIndicator_selectedBold, defaultSelectedBold);
            float textSize = a.getDimension(C0485R.styleable.TitlePageIndicator_android_textSize, defaultTextSize);
            int footerColor = a.getColor(C0485R.styleable.TitlePageIndicator_footerColor, defaultFooterColor);
            ...
            Drawable background = a.getDrawable(C0485R.styleable.TitlePageIndicator_android_background);
            if (background != null) {
