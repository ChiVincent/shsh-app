...
public class UnderlinePageIndicator extends View implements PageIndicator {
    ...
    static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = new C04921();
        int currentPage;

        static class C04921 implements Creator<SavedState> {
            C04921() {
            }
    ...
    public UnderlinePageIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, C0485R.attr.vpiUnderlinePageIndicatorStyle);
    }
    ...
    public UnderlinePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mFadeRunnable = new C04901();
        if (!isInEditMode()) {
            Resources res = getResources();
            boolean defaultFades = res.getBoolean(C0485R.bool.default_underline_indicator_fades);
            int defaultFadeDelay = res.getInteger(C0485R.integer.default_underline_indicator_fade_delay);
            int defaultFadeLength = res.getInteger(C0485R.integer.default_underline_indicator_fade_length);
            int defaultSelectedColor = res.getColor(C0485R.color.default_underline_indicator_selected_color);
            TypedArray a = context.obtainStyledAttributes(attrs, C0485R.styleable.UnderlinePageIndicator, defStyle, 0);
            setFades(a.getBoolean(C0485R.styleable.UnderlinePageIndicator_fades, defaultFades));
            setSelectedColor(a.getColor(C0485R.styleable.UnderlinePageIndicator_selectedColor, defaultSelectedColor));
            setFadeDelay(a.getInteger(C0485R.styleable.UnderlinePageIndicator_fadeDelay, defaultFadeDelay));
            setFadeLength(a.getInteger(C0485R.styleable.UnderlinePageIndicator_fadeLength, defaultFadeLength));
            Drawable background = a.getDrawable(C0485R.styleable.UnderlinePageIndicator_android_background);
            if (background != null) {
