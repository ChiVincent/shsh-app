...
public abstract class zzl<T extends IInterface> extends zzf<T> implements zze, zza {
    ...
    class C07311 implements zzb {
        final /* synthetic */ ConnectionCallbacks zzaEu;

        C07311(ConnectionCallbacks connectionCallbacks) {
    ...
    class C07322 implements zzc {
        final /* synthetic */ OnConnectionFailedListener zzaEv;

        C07322(OnConnectionFailedListener onConnectionFailedListener) {
    ...
    private static zzb zza(ConnectionCallbacks connectionCallbacks) {
        return connectionCallbacks == null ? null : new C07311(connectionCallbacks);
    }

    @Nullable
    private static zzc zza(OnConnectionFailedListener onConnectionFailedListener) {
        return onConnectionFailedListener == null ? null : new C07322(onConnectionFailedListener);
    }
