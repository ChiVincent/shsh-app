...
public final class ConnectionResult extends zza {
    ...
    public String toString() {
        return zzaa.zzv(this).zzg("statusCode", getStatusString(this.zzauz)).zzg("resolution", this.mPendingIntent).zzg(SettingsJsonConstants.PROMPT_MESSAGE_KEY, this.zzawY).toString();
    }
