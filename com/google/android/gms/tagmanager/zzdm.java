...
public class zzdm {
    ...
    private static double getDouble(Object obj) {
        ...
        zzbo.m10e("getDouble received non-Number");
        return 0.0d;
    }
    ...
    public static zzdl zzN(Object obj) {
        return obj instanceof zzdl ? (zzdl) obj : zzT(obj) ? zzdl.zzax(zzU(obj)) : zzS(obj) ? zzdl.zza(Double.valueOf(getDouble(obj))) : zzhA(zzM(obj));
    }

    public static Long zzO(Object obj) {
        return zzT(obj) ? Long.valueOf(zzU(obj)) : zzhB(zzM(obj));
    }

    public static Double zzP(Object obj) {
        return zzS(obj) ? Double.valueOf(getDouble(obj)) : zzhC(zzM(obj));
    }
    ...
    private static long zzU(Object obj) {
        ...
        zzbo.m10e("getInt64 received non-Number");
        return 0;
    }
    ...
    public static zzdl zzf(zza com_google_android_gms_internal_zzaj_zza) {
        return zzN(zzj(com_google_android_gms_internal_zzaj_zza));
    }

    public static Long zzg(zza com_google_android_gms_internal_zzaj_zza) {
        return zzO(zzj(com_google_android_gms_internal_zzaj_zza));
    }

    public static Double zzh(zza com_google_android_gms_internal_zzaj_zza) {
        return zzP(zzj(com_google_android_gms_internal_zzaj_zza));
    }

    private static zzdl zzhA(String str) {
        try {
            return zzdl.zzhy(str);
        } catch (NumberFormatException e) {
            zzbo.m10e(new StringBuilder(String.valueOf(str).length() + 33).append("Failed to convert '").append(str).append("' to a number.").toString());
            return zzbGJ;
        }
    }

    private static Long zzhB(String str) {
        zzdl zzhA = zzhA(str);
        return zzhA == zzbGJ ? zzbGH : Long.valueOf(zzhA.longValue());
    }

    private static Double zzhC(String str) {
        zzdl zzhA = zzhA(str);
        return zzhA == zzbGJ ? zzbGI : Double.valueOf(zzhA.doubleValue());
    }
    ...
    public static zza zzhz(String str) {
        zza com_google_android_gms_internal_zzaj_zza = new zza();
        com_google_android_gms_internal_zzaj_zza.type = 5;
        com_google_android_gms_internal_zzaj_zza.zzlB = str;
        return com_google_android_gms_internal_zzaj_zza;
    }
    ...
    public static Object zzj(zza com_google_android_gms_internal_zzaj_zza) {
        ...
        switch (com_google_android_gms_internal_zzaj_zza.type) {
            ...
            case 3:
                ...
                return hashMap;
            case 4:
                zzbo.m10e("Trying to convert a macro reference to object");
                return null;
            case 5:
                zzbo.m10e("Trying to convert a function id to object");
                return null;
            case 6:
            ...
            default:
                zzbo.m10e("Failed to convert a value of type: " + com_google_android_gms_internal_zzaj_zza.type);
                return null;
        }
    }
}
