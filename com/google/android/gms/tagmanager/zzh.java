...
class zzh extends zzam {
    private static final String ID = zzag.APP_VERSION.toString();
    ...
    public zza zzY(Map<String, zza> map) {
        try {
            return zzdm.zzR(Integer.valueOf(this.mContext.getPackageManager().getPackageInfo(this.mContext.getPackageName(), 0).versionCode));
