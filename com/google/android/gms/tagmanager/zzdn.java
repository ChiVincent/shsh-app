...
public class zzdn extends zzdk {
    ...
    private static final String zzbGP = zzah.ACCOUNT.toString();
    private static final String zzbGQ = zzah.ANALYTICS_PASS_THROUGH.toString();
    private static final String zzbGR = zzah.ENABLE_ECOMMERCE.toString();
    private static final String zzbGS = zzah.ECOMMERCE_USE_DATA_LAYER.toString();
    private static final String zzbGT = zzah.ECOMMERCE_MACRO_DATA.toString();
    private static final String zzbGU = zzah.ANALYTICS_FIELDS.toString();
    private static final String zzbGV = zzah.TRACK_TRANSACTION.toString();
    private static final String zzbGW = zzah.TRANSACTION_DATALAYER_MAP.toString();
    private static final String zzbGX = zzah.TRANSACTION_ITEM_DATALAYER_MAP.toString();
    private static final List<String> zzbGY = Arrays.asList(new String[]{ProductAction.ACTION_DETAIL, ProductAction.ACTION_CHECKOUT, ProductAction.ACTION_CHECKOUT_OPTION, "click", ProductAction.ACTION_ADD, ProductAction.ACTION_REMOVE, ProductAction.ACTION_PURCHASE, ProductAction.ACTION_REFUND});
    ...
    zzdn(Context context, DataLayer dataLayer, zzdj com_google_android_gms_tagmanager_zzdj) {
        ...
        this.zzbHe = com_google_android_gms_tagmanager_zzdj;
        this.zzbHd = new HashSet();
        this.zzbHd.add("");
        this.zzbHd.add("0");
    ...
    private void zza(Tracker tracker, Map<String, zza> map) {
        String zzhE = zzhE("transactionId");
        if (zzhE == null) {
            zzbo.m10e("Cannot find transactionId in data layer.");
            return;
        }
        List<Map> linkedList = new LinkedList();
        try {
            Map zzk = zzk((zza) map.get(zzbGU));
            zzk.put("&t", "transaction");
            for (Entry entry : zzak(map).entrySet()) {
                zze(zzk, (String) entry.getValue(), zzhE((String) entry.getKey()));
            }
            linkedList.add(zzk);
            ...
            if (zzhF != null) {
                for (Map map2 : zzhF) {
                    if (map2.get("name") == null) {
                        zzbo.m10e("Unable to send transaction item hit due to missing 'name' field.");
                        return;
                    }
                    Map zzk2 = zzk((zza) map.get(zzbGU));
                    zzk2.put("&t", "item");
                    zzk2.put("&ti", zzhE);
                    for (Entry entry2 : zzal(map).entrySet()) {
    ...
    private Promotion zzai(Map<String, String> map) {
    ...
    private Product zzaj(Map<String, Object> map) {
        String str;
        ...
        for (String str2 : map.keySet()) {
            ...
            if (matcher.matches()) {
                try {
                    ...
                    zzbo.zzbe(str22.length() != 0 ? str.concat(str22) : new String(str));
                }
            } else {
    ...
    private Map<String, String> zzak(Map<String, zza> map) {
        zza com_google_android_gms_internal_zzaj_zza = (zza) map.get(zzbGW);
    ...
    private Map<String, String> zzal(Map<String, zza> map) {
        zza com_google_android_gms_internal_zzaj_zza = (zza) map.get(zzbGX);
        if (com_google_android_gms_internal_zzaj_zza != null) {
            return zzc(com_google_android_gms_internal_zzaj_zza);
        }
        if (zzbHc == null) {
    ...
    private void zzb(Tracker tracker, Map<String, zza> map) {
        ...
        if (zzi(map, zzbGS)) {
            obj = this.zzbCT.get("ecommerce");
            map2 = obj instanceof Map ? (Map) obj : null;
        } else {
            obj = zzdm.zzj((zza) map.get(zzbGT));
            map2 = obj instanceof Map ? (Map) obj : null;
        }
        if (map2 != null) {
            Map map3;
            ...
            if (obj instanceof List) {
                for (Map map4 : (List) obj) {
                    try {
                        screenViewBuilder.addImpression(zzaj(map4), (String) map4.get("list"));
                    } catch (RuntimeException e) {
                        str = "Failed to extract a product from DataLayer. ";
                        str2 = String.valueOf(e.getMessage());
                        zzbo.m10e(str2.length() != 0 ? str.concat(str2) : new String(str));
                    }
                }
            }
            ...
            if (r0 != null) {
                for (Map map42 : r0) {
                    try {
                        screenViewBuilder.addPromotion(zzai(map42));
                        ...
                        for (String str22 : zzbGY) {
                            if (map2.containsKey(str22)) {
                                ...
                                if (list != null) {
                                    for (Map map22 : list) {
                                        try {
                                            screenViewBuilder.addProduct(zzaj(map22));
                                ...
                                try {
                                    ...
                                    zzbo.m10e(str22.length() != 0 ? str3.concat(str22) : new String(str3));
                                }
                            }
                        }
                    }
    ...
    private String zzhE(String str) {
        Object obj = this.zzbCT.get(str);
        return obj == null ? null : obj.toString();
    }

    private List<Map<String, String>> zzhF(String str) {
        Object obj = this.zzbCT.get(str);
        if (obj == null) {
            return null;
        }
    ...
    private boolean zzi(Map<String, zza> map, String str) {
        ...
        return com_google_android_gms_internal_zzaj_zza == null ? false : zzdm.zzi(com_google_android_gms_internal_zzaj_zza).booleanValue();
    }

    private Map<String, String> zzk(zza com_google_android_gms_internal_zzaj_zza) {
        if (com_google_android_gms_internal_zzaj_zza == null) {
            return new HashMap();
        }
        ...
        if (str != null && this.zzbHd.contains(str.toLowerCase())) {
            zzc.remove("&aip");
        }
        return zzc;
    }

    public /* bridge */ /* synthetic */ boolean zzOw() {
        return super.zzOw();
    }
    ...
    public /* bridge */ /* synthetic */ zza zzY(Map map) {
        return super.zzY(map);
    }

    public void zzaa(Map<String, zza> map) {
        Tracker zzhw = this.zzbHe.zzhw("_GTM_DEFAULT_TRACKER_");
        zzhw.enableAdvertisingIdCollection(zzi(map, "collect_adid"));
        if (zzi(map, zzbGR)) {
            zzb(zzhw, map);
        } else if (zzi(map, zzbGQ)) {
            zzhw.send(zzk((zza) map.get(zzbGU)));
        } else if (zzi(map, zzbGV)) {
            zza(zzhw, map);
        } else {
