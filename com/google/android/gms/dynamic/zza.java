...
public abstract class zza<T extends LifecycleDelegate> {
    ...
    class C07331 implements zzf<T> {
        final /* synthetic */ zza zzaQh;

        C07331(zza com_google_android_gms_dynamic_zza) {
    ...
    class C07376 implements zza {
        final /* synthetic */ zza zzaQh;

        C07376(zza com_google_android_gms_dynamic_zza) {
            this.zzaQh = com_google_android_gms_dynamic_zza;
        }
    ...
    class C07387 implements zza {
        final /* synthetic */ zza zzaQh;

        C07387(zza com_google_android_gms_dynamic_zza) {
            this.zzaQh = com_google_android_gms_dynamic_zza;
        }
    ...
    static void zza(FrameLayout frameLayout, GoogleApiAvailability googleApiAvailability) {
        ...
        if (zzb != null) {
            ...
            button.setOnClickListener(new C03245(context, zzb));
        }
    }
