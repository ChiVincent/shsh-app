...
public class zztg {
    ...
    public static zzrf zza(zzsx com_google_android_gms_internal_zzsx, String str) {
        ...
        try {
            ...
            Map zza = zzn.zza(new URI(valueOf.length() != 0 ? str2.concat(valueOf) : new String(str2)), HttpRequest.CHARSET_UTF8);
    ...
    public static boolean zza(double d, String str) {
        return d > 0.0d && d < 100.0d && ((double) (zzch(str) % AbstractSpiCall.DEFAULT_TIMEOUT)) >= 100.0d * d;
    }
