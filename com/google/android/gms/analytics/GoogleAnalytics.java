...
public final class GoogleAnalytics extends zza {
    ...
    private Set<zza> zzaaG = new HashSet();
    ...
    public void setLogger(Logger logger) {
        ...
        if (!this.zzaaK) {
            ...
            Log.i((String) zzsq.zzaek.get(), new StringBuilder(String.valueOf(str).length() + 112).append("GoogleAnalytics.setLogger() is deprecated. To enable debug logging, please run:\nadb shell setprop log.tag.").append(str).append(" DEBUG").toString());
            this.zzaaK = true;
        }
    }
