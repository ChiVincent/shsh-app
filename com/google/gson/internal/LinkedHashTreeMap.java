...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C04501();
    ...
    static class C04501 implements Comparator<Comparable> {
        C04501() {
        }
    ...
    final class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C08131 extends LinkedTreeMapIterator<Entry<K, V>> {
            C08131() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C08141 extends LinkedTreeMapIterator<K> {
            C08141() {
                super();
            }
