...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C04511();
    ...
    static class C04511 implements Comparator<Comparable> {
        C04511() {
        }
    ...
    class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C08151 extends LinkedTreeMapIterator<Entry<K, V>> {
            C08151() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C08161 extends LinkedTreeMapIterator<K> {
            C08161() {
                super();
            }
