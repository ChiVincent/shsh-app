...
class BitmapHunter implements Runnable {
    ...
    private static final RequestHandler ERRORING_HANDLER = new C08472();
    private static final ThreadLocal<StringBuilder> NAME_BUILDER = new C04671();
    ...
    static class C04671 extends ThreadLocal<StringBuilder> {
        C04671() {
        }
    ...
    static class C08472 extends RequestHandler {
        C08472() {
        }
