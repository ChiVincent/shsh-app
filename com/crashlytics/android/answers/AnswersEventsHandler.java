...
class AnswersEventsHandler implements EventsStorageListener {
    ...
    class C02342 implements Runnable {
        ...
        public void run() {
            try {
                ...
                Fabric.getLogger().mo2379e(Answers.TAG, "Failed to disable events", e);
            }
        }
    }
    ...
    class C02353 implements Runnable {
        ...
        public void run() {
            try {
                ...
                Fabric.getLogger().mo2379e(Answers.TAG, "Failed to send events files", e);
            }
        }
    }
    ...
    class C02364 implements Runnable {
        ...
        public void run() {
            try {
                ...
                Fabric.getLogger().mo2379e(Answers.TAG, "Failed to enable events", e);
            }
        }
    }
    ...
    class C02375 implements Runnable {
        ...
        public void run() {
            try {
                ...
                Fabric.getLogger().mo2379e(Answers.TAG, "Failed to flush events", e);
            }
        }
    }
        ...
        executeAsync(new Runnable() {
            public void run() {
                try {
                    ...
                    Fabric.getLogger().mo2379e(Answers.TAG, "Failed to set analytics settings data", e);
                }
            }
        });
    }
    ...
    public void disable() {
        executeAsync(new C02342());
    }

    public void onRollOver(String rolledOverFile) {
        executeAsync(new C02353());
    }

    public void enable() {
        executeAsync(new C02364());
    }

    public void flushEvents() {
        executeAsync(new C02375());
    }
        ...
        Runnable runnable = new Runnable() {
            public void run() {
                try {
                    ...
                    Fabric.getLogger().mo2379e(Answers.TAG, "Failed to process event", e);
                }
            }
        };
        if (sync) {
    ...
    private void executeSync(Runnable runnable) {
        try {
            ...
            Fabric.getLogger().mo2379e(Answers.TAG, "Failed to run events task", e);
        }
    }
    ...
    private void executeAsync(Runnable runnable) {
        try {
            ...
            Fabric.getLogger().mo2379e(Answers.TAG, "Failed to submit events task", e);
        }
    }
}
